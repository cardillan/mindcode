...
public class SchemacodeParser extends Parser {
	...
	public static final int
		...
		RULE_block = 8, RULE_blockId = 9, RULE_labelList = 10, RULE_labelId = 11, 
		RULE_pattern = 12, RULE_blockPosition = 13, RULE_position = 14, RULE_coordinates = 15, 
		RULE_relativeCoordinates = 16, RULE_coordinatesRelativeTo = 17, RULE_direction = 18, 
		RULE_configuration = 19, RULE_colorDef = 20, RULE_connectionList = 21, 
		RULE_connection = 22, RULE_processor = 23, RULE_processorLinks = 24, RULE_linkDef = 25, 
		RULE_program = 26, RULE_programSnippet = 27, RULE_textDef = 28, RULE_parametrization = 29, 
		RULE_parameter = 30, RULE_stringValue = 31, RULE_stringLiteral = 32, RULE_simpleStringLiteral = 33;
	private static String[] makeRuleNames() {
		return new String[] {
			"definitions", "definition", "schematic", "schematicItem", "attribute", 
			"number", "versionNumber", "region", "block", "blockId", "labelList", 
			"labelId", "pattern", "blockPosition", "position", "coordinates", "relativeCoordinates", 
	...
	public final LabelIdContext labelId() throws RecognitionException {
		...
		enterRule(_localctx, 22, RULE_labelId);
		try {
			int _alt;
			enterOuterAlt(_localctx, 1);
			{
	...
	public final BlockPositionContext blockPosition() throws RecognitionException {
		...
		enterRule(_localctx, 26, RULE_blockPosition);
		int _la;
		try {
			setState(231);
			_errHandler.sync(this);
	...
	public final RelativeCoordinatesContext relativeCoordinates() throws RecognitionException {
		...
		enterRule(_localctx, 32, RULE_relativeCoordinates);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final CoordinatesRelativeToContext coordinatesRelativeTo() throws RecognitionException {
		...
		enterRule(_localctx, 34, RULE_coordinatesRelativeTo);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(247);
	...
	public final ConfigurationContext configuration() throws RecognitionException {
		...
		enterRule(_localctx, 38, RULE_configuration);
		int _la;
		try {
			setState(273);
			_errHandler.sync(this);
	...
	public final ColorDefContext colorDef() throws RecognitionException {
		...
		enterRule(_localctx, 40, RULE_colorDef);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(275);
	...
	public final ConnectionListContext connectionList() throws RecognitionException {
		...
		enterRule(_localctx, 42, RULE_connectionList);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final ConnectionContext connection() throws RecognitionException {
		...
		enterRule(_localctx, 44, RULE_connection);
		try {
			setState(297);
			_errHandler.sync(this);
			switch (_input.LA(1)) {
	...
	public final ProcessorContext processor() throws RecognitionException {
		...
		enterRule(_localctx, 46, RULE_processor);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final ProcessorLinksContext processorLinks() throws RecognitionException {
		...
		enterRule(_localctx, 48, RULE_processorLinks);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final LinkDefContext linkDef() throws RecognitionException {
		...
		enterRule(_localctx, 50, RULE_linkDef);
		int _la;
		try {
			setState(334);
			_errHandler.sync(this);
	...
	public final ProgramSnippetContext programSnippet() throws RecognitionException {
		...
		enterRule(_localctx, 54, RULE_programSnippet);
		try {
			setState(347);
			_errHandler.sync(this);
			switch (_input.LA(1)) {
	...
	public final TextDefContext textDef() throws RecognitionException {
		...
		enterRule(_localctx, 56, RULE_textDef);
		try {
			setState(351);
			_errHandler.sync(this);
			switch (_input.LA(1)) {
	...
	public final ParametrizationContext parametrization() throws RecognitionException {
		...
		enterRule(_localctx, 58, RULE_parametrization);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final SimpleStringLiteralContext simpleStringLiteral() throws RecognitionException {
		...
		enterRule(_localctx, 66, RULE_simpleStringLiteral);
		try {
