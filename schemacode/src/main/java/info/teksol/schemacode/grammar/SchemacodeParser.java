...
public class SchemacodeParser extends Parser {
	...
	public static final int
		...
		RANDOM=30, REPLACE=31, REGION=32, RGBA=33, SCHEMATIC=34, TAG=35, TARGET=36, 
		TEXT=37, TO=38, UNIT=39, VERTICAL=40, VIRTUAL=41, ASSIGN=42, COLON=43, 
		COMMA=44, DOT=45, DOT2=46, DOT3=47, MINUS=48, MUL=49, PLUS=50, NORTH=51, 
		SOUTH=52, EAST=53, WEST=54, LEFTPAREN=55, RIGHTPAREN=56, TEXTBLOCK1=57, 
		TEXTBLOCK2=58, TEXTLINE=59, INT=60, SIGNEDINT=61, ID=62, ID_ARRAY=63, 
		TYPE=64, PATTERN=65, VERSION=66, COMMENT=67, SLCOMMENT=68, WS=69, ANY=70, 
		PARAMEND=71, PARAMASSIGN=72, PARAMCOMMENT=73, PARAMSLCOMMENT=74, PARAMWHITESPACE=75, 
		PARAMSTRING=76, PARAMTOKEN=77;
	public static final int
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'mlog'", "'name'", "'param'", "'parent'", "'processor'", "'random'", 
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"RANDOM", "REPLACE", "REGION", "RGBA", "SCHEMATIC", "TAG", "TARGET", 
			...
			"INT", "SIGNEDINT", "ID", "ID_ARRAY", "TYPE", "PATTERN", "VERSION", "COMMENT", 
	...
	public final SchematicContext schematic() throws RecognitionException {
		...
		try {
			...
			do {
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
			} while ( ((((_la - 7)) & ~0x3f) == 0 && ((1L << (_la - 7)) & 252201579972526211L) != 0) );
			setState(97);
			match(END);
			}
		}
	...
	public final RegionDefinitionContext regionDefinition() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (((((_la - 32)) & ~0x3f) == 0 && ((1L << (_la - 32)) & 7516192769L) != 0)) {
				{
				{
				setState(140);
	...
	public final BlockContext block() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 2147516420L) != 0)) {
				{
				setState(158);
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 2886757516920L) != 0)) {
				{
				setState(170);
	...
	public final DirectionContext direction() throws RecognitionException {
		...
		try {
			...
			_la = _input.LA(1);
			if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & 33776998279020544L) != 0)) ) {
	...
	public final PatternSegmentContext patternSegment() throws RecognitionException {
		...
		try {
			...
			_la = _input.LA(1);
			if ( !(((((_la - 17)) & ~0x3f) == 0 && ((1L << (_la - 17)) & 316663643768865L) != 0)) ) {
	...
	public final ProcessorLinksContext processorLinks() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (((((_la - 17)) & ~0x3f) == 0 && ((1L << (_la - 17)) & 316949259094049L) != 0)) {
				{
				{
				setState(323);
				linkDef();
