...
public class SchemacodeParser extends Parser {
	...
	public static final int
		...
		PARAM=23, PROCESSOR=24, RANDOM=25, REGION=26, RGBA=27, SCHEMATIC=28, TAG=29, 
		TARGET=30, TEXT=31, TO=32, UNIT=33, VERTICAL=34, VIRTUAL=35, ASSIGN=36, 
		COLON=37, COMMA=38, DOT=39, DOT2=40, DOT3=41, MINUS=42, MUL=43, PLUS=44, 
		NORTH=45, SOUTH=46, EAST=47, WEST=48, LEFTPAREN=49, RIGHTPAREN=50, TEXTBLOCK1=51, 
		TEXTBLOCK2=52, TEXTLINE=53, INT=54, SIGNEDINT=55, ID=56, BLOCKID=57, REF=58, 
		PATTERN=59, VERSION=60, COMMENT=61, SLCOMMENT=62, WS=63, ANY=64, PARAMEND=65, 
		PARAMASSIGN=66, PARAMCOMMENT=67, PARAMSLCOMMENT=68, PARAMWHITESPACE=69, 
		PARAMSTRING=70, PARAMTOKEN=71;
	public static final int
		...
		RULE_regionDimensions = 8, RULE_block = 9, RULE_blockId = 10, RULE_labelList = 11, 
		RULE_labelId = 12, RULE_pattern = 13, RULE_blockPosition = 14, RULE_position = 15, 
		RULE_coordinates = 16, RULE_relativeCoordinates = 17, RULE_coordinatesRelativeTo = 18, 
		RULE_direction = 19, RULE_configuration = 20, RULE_colorDef = 21, RULE_connectionList = 22, 
		RULE_connection = 23, RULE_processor = 24, RULE_processorLinks = 25, RULE_linkDef = 26, 
		RULE_program = 27, RULE_programSnippet = 28, RULE_textDef = 29, RULE_parametrization = 30, 
		RULE_parameter = 31, RULE_stringValue = 32, RULE_stringLiteral = 33, RULE_simpleStringLiteral = 34;
	private static String[] makeRuleNames() {
		return new String[] {
			"definitions", "definition", "schematic", "schematicItem", "attribute", 
			"number", "versionNumber", "region", "regionDimensions", "block", "blockId", 
			"labelList", "labelId", "pattern", "blockPosition", "position", "coordinates", 
			"relativeCoordinates", "coordinatesRelativeTo", "direction", "configuration", 
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'random'", "'region'", "'rgba'", "'schematic'", "'tag'", "'target'", 
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"NAME", "PARAM", "PROCESSOR", "RANDOM", "REGION", "RGBA", "SCHEMATIC", 
			...
			"TEXTLINE", "INT", "SIGNEDINT", "ID", "BLOCKID", "REF", "PATTERN", "VERSION", 
			"COMMENT", "SLCOMMENT", "WS", "ANY", "PARAMEND", "PARAMASSIGN", "PARAMCOMMENT", 
	...
	public final SchematicContext schematic() throws RecognitionException {
		...
		try {
			...
			do {
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
			} while ( (((_la) & ~0x3f) == 0 && ((1L << _la) & 504403159950573952L) != 0) );
			setState(91);
			match(END);
			}
		}
	...
	public final RegionContext region() throws RecognitionException {
		...
		try {
			...
			if (_la==LEFTPAREN) {
				{
				setState(131);
				((RegionContext)_localctx).dimensions = regionDimensions();
				}
			}
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 504403158332604416L) != 0)) {
				{
				{
				setState(134);
	...
	public final BlockContext block() throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 45114263160L) != 0)) {
					{
					setState(157);
			...
			case 3:
				...
				if (_la==LEFTPAREN) {
					{
					setState(176);
					((BlockContext)_localctx).dimensions = regionDimensions();
					}
				}
	...
	public final BlockIdContext blockId() throws RecognitionException {
		...
		enterRule(_localctx, 20, RULE_blockId);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final LabelListContext labelList() throws RecognitionException {
		...
		enterRule(_localctx, 22, RULE_labelList);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public static class LabelIdContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof SchemacodeParserListener ) ((SchemacodeParserListener)listener).enterLabelId(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof SchemacodeParserListener ) ((SchemacodeParserListener)listener).exitLabelId(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof SchemacodeParserVisitor ) return ((SchemacodeParserVisitor<? extends T>)visitor).visitLabelId(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public final LabelIdContext labelId() throws RecognitionException {
		...
		enterRule(_localctx, 24, RULE_labelId);
		try {
			int _alt;
			enterOuterAlt(_localctx, 1);
			{
	...
	public final CoordinatesRelativeToContext coordinatesRelativeTo() throws RecognitionException {
		...
		try {
			...
			{
			setState(261);
			((CoordinatesRelativeToContext)_localctx).label = labelId();
			setState(262);
	...
	public final DirectionContext direction() throws RecognitionException {
		...
		try {
			...
			_la = _input.LA(1);
			if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & 527765614886912L) != 0)) ) {
	...
	public final ColorDefContext colorDef() throws RecognitionException {
		...
		enterRule(_localctx, 42, RULE_colorDef);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(289);
	...
	public final ConnectionListContext connectionList() throws RecognitionException {
		...
		enterRule(_localctx, 44, RULE_connectionList);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final ProcessorContext processor() throws RecognitionException {
		...
		enterRule(_localctx, 48, RULE_processor);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final ProcessorLinksContext processorLinks() throws RecognitionException {
		...
		enterRule(_localctx, 50, RULE_processorLinks);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 649112082620350464L) != 0)) {
				{
				{
				setState(331);
				linkDef();
	...
	public final LinkDefContext linkDef() throws RecognitionException {
		...
		enterRule(_localctx, 52, RULE_linkDef);
		int _la;
		try {
			setState(348);
			_errHandler.sync(this);
	...
	public final ProgramSnippetContext programSnippet() throws RecognitionException {
		...
		enterRule(_localctx, 56, RULE_programSnippet);
		try {
			setState(361);
			_errHandler.sync(this);
			switch (_input.LA(1)) {
	...
	public final TextDefContext textDef() throws RecognitionException {
		...
		enterRule(_localctx, 58, RULE_textDef);
		try {
			setState(365);
			_errHandler.sync(this);
			switch (_input.LA(1)) {
	...
	public final ParametrizationContext parametrization() throws RecognitionException {
		...
		enterRule(_localctx, 60, RULE_parametrization);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final SimpleStringLiteralContext simpleStringLiteral() throws RecognitionException {
		...
		enterRule(_localctx, 68, RULE_simpleStringLiteral);
		try {
