    ...
    void generatesCaseWhenElse() {
        assertLogicInstructionsMatch(
                List.of(
                        ...
                        new LogicInstruction(SET, var(2), "1"),
                        new LogicInstruction(JUMP, var(1001), "equal", var(0), var(2)),
                        new LogicInstruction(JUMP, var(1002), "always"),
                        new LogicInstruction(LABEL, var(1001)),
                        new LogicInstruction(SET, var(3), "\"1\""),
                        ...
                        new LogicInstruction(JUMP, var(1003), "equal", var(0), var(4)),
    ...
    void generatesCaseWhen() {
        assertLogicInstructionsMatch(
                List.of(
                        new LogicInstruction(SET, var(0), "0"),
                        new LogicInstruction(READ, var(1), "cell1", var(0)),
                        new LogicInstruction(SET, var(100), var(1)),
                        new LogicInstruction(JUMP, var(1002), "equal", var(100), "ST_EMPTY"),
                        new LogicInstruction(JUMP, var(1001), "always"),
                        new LogicInstruction(LABEL, var(1002)),
                        new LogicInstruction(SET, var(3), "0"),
                        new LogicInstruction(WRITE, "ST_INITIALIZED", "cell1", var(3)),
                        new LogicInstruction(SET, var(2), "ST_INITIALIZED"),
                        new LogicInstruction(JUMP, var(1000), "always"),
                        new LogicInstruction(LABEL, var(1001)),
                        new LogicInstruction(JUMP, var(1004), "equal", var(100), "ST_INITIALIZED"),
                        new LogicInstruction(JUMP, var(1003), "always"),
                        new LogicInstruction(LABEL, var(1004)),
                        new LogicInstruction(SET, var(4), "0"),
                        new LogicInstruction(WRITE, "ST_DONE", "cell1", var(4)),
                        new LogicInstruction(SET, var(2), "ST_DONE"),
                        new LogicInstruction(JUMP, var(1000), "always"),
                        new LogicInstruction(LABEL, var(1003)),
    ...
    void generatesCaseWhenMultiple() {
        assertLogicInstructionsMatch(
                List.of(
                        ...
                        new LogicInstruction(JUMP, var(1002), "equal", var(100), var(3)),
                        new LogicInstruction(JUMP, var(1001), "always"),
                        new LogicInstruction(LABEL, var(1002)),
                        ...
                        new LogicInstruction(JUMP, var(1004), "equal", var(100), var(7)),
                        new LogicInstruction(JUMP, var(1003), "always"),
                        new LogicInstruction(LABEL, var(1004)),
    ...
    void generatesCaseWhenMultipleWithRanges() {
        assertLogicInstructionsMatch(
                List.of(
                        new LogicInstruction(SET, "__ast0", "n"),
                        new LogicInstruction(SET, var(1), "0"),
                        new LogicInstruction(JUMP, var(1003), "lessThan", "__ast0", var(1)),
                        new LogicInstruction(SET, var(2), "4"),
                        new LogicInstruction(JUMP, var(1002), "lessThanEq", "__ast0", var(2)),
                        new LogicInstruction(LABEL, var(1003)),
                        new LogicInstruction(SET, var(3), "6"),
                        new LogicInstruction(JUMP, var(1004), "lessThan", "__ast0", var(3)),
                        new LogicInstruction(SET, var(4), "8"),
                        new LogicInstruction(JUMP, var(1002), "lessThanEq", "__ast0", var(4)),
                        new LogicInstruction(LABEL, var(1004)),
                        new LogicInstruction(SET, var(5), "10"),
                        new LogicInstruction(JUMP, var(1002), "equal", "__ast0", var(5)),
                        new LogicInstruction(SET, var(6), "12"),
                        new LogicInstruction(JUMP, var(1002), "equal", "__ast0", var(6)),
                        new LogicInstruction(JUMP, var(1001), "always"),
                        new LogicInstruction(LABEL, var(1002)),
                        new LogicInstruction(SET, var(7), "\"A number I like\""),
                        new LogicInstruction(SET, var(0), var(7)),
                        new LogicInstruction(JUMP, var(1000), "always"),
                        new LogicInstruction(LABEL, var(1001)),
    ...
    void supportsLogiclessCaseWhen() {
        assertLogicInstructionsMatch(
                List.of(
                        ...
                        new LogicInstruction(SET, var(3), var(2)),
                        new LogicInstruction(SET, var(5), "0"),
                        new LogicInstruction(JUMP, var(1001), "equal", var(3), var(5)),
                        new LogicInstruction(JUMP, var(1002), "always"),
                        new LogicInstruction(LABEL, var(1001)),
                        ...
                        new LogicInstruction(LABEL, var(1002)),
                        new LogicInstruction(SET, var(7), "1"),
                        new LogicInstruction(JUMP, var(1003), "equal", var(3), var(7)),
                        new LogicInstruction(JUMP, var(1004), "always"),
                        new LogicInstruction(LABEL, var(1003)),
    ...
    void generatesCorrectCodeWhenCaseBranchIsCommentedOut() {
        assertLogicInstructionsMatch(
                List.of(
                        ...
                        new LogicInstruction(JUMP, var(1001), "equal", "__ast0", var(1)),
                        new LogicInstruction(JUMP, var(1002), "always"),
                        new LogicInstruction(LABEL, var(1001)),
                        new LogicInstruction(PRINT, "n"),
