    ...
    void generatesIndirectRecursion() {
        assertLogicInstructionsMatch(
                List.of(
                        ...
                        createInstruction(CALL, "bank1", var(1001), var(1004)),
    ...
    void functionsCanCallOtherFunctionsStackless() {
        assertLogicInstructionsMatch(
                List.of(
                        ...
                        createInstruction(SET, "__fn2retaddr", var(1008)),
                        createInstruction(SET, "@counter", var(1002)),
                        ...
                        // call bar
                        createInstruction(SET, "__fn0_n", "__fn1_n"),
                        createInstruction(SET, "__fn0retaddr", var(1010)),
                        createInstruction(SET, "@counter", var(1000)),
    ...
    void canIndirectlyReferenceStack() {
        assertLogicInstructionsMatch(
                List.of(
                        ...
                        // Function definition
                        createInstruction(LABEL, var(1000)),
                        createInstruction(CALL, "STACKPTR", var(1000), var(1004)),
                        createInstruction(LABEL, var(1004)),
