...
@NullMarked
@Order(1)
public class OptimizerSymbolicLabelsTest extends AbstractProcessorTest {
    ...
    static void done() throws IOException {
        AbstractProcessorTest.done(SCRIPTS_DIRECTORY, OptimizerSymbolicLabelsTest.class.getSimpleName());
    }
