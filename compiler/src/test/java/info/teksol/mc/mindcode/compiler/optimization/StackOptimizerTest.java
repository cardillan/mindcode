...
class StackOptimizerTest extends AbstractOptimizerTest<StackOptimizer> {
    ...
    void removesUnusedParameter() {
        assertCompilesTo("""
                ...
                createInstruction(SET, ":foo.0:x", "5"),
                ...
                createInstruction(OP, "sub", tmp(1), ":foo.0:x", "1"),
    ...
    void keepsUsedParameter() {
        assertCompilesTo("""
                ...
                createInstruction(SET, ":foo.0*retval", ":foo.0:x"),
                createInstruction(RETURNREC, "bank1")
        );
    }
    ...
    void keepsVariablesInLoop() {
        ...
        assertCompilesTo("""
                ...
                createInstruction(END),
                createInstruction(LABEL, label(0)),
                createInstruction(SET, ":foo.0:z", ":foo.0:x"),
                createInstruction(PRINT, ":foo.0:z"),
                createInstruction(LABEL, label(4)),
                createInstruction(JUMP, label(6), "equal", "true", "false"),
                createInstruction(SET, ":foo.0:y", ":foo.0:x"),
                createInstruction(PRINT, ":foo.0:y"),
                createInstruction(PUSH, "bank1", ":foo.0:y"),
                createInstruction(CALLREC, "bank1", label(0), label(7), ":foo.0*retval"),
                createInstruction(LABEL, label(7)),
                createInstruction(POP, "bank1", ":foo.0:y"),
    ...
    void removesVariablesNotInLoop() {
        assertCompilesTo("""
                ...
                createInstruction(JUMP, label(6), "equal", "true", "false"),
                createInstruction(OP, "sub", tmp(1), ":foo.0:x", "1"),
                createInstruction(SET, ":foo.0:y", tmp(1)),
                createInstruction(PUSH, "bank1", ":foo.0:x"),
                createInstruction(PUSH, "bank1", ":foo.0:y"),
                createInstruction(SET, ":foo.0:x", "2"),
                createInstruction(CALLREC, "bank1", label(0), label(7), ":foo.0*retval"),
                createInstruction(LABEL, label(7)),
                createInstruction(POP, "bank1", ":foo.0:y"),
                createInstruction(POP, "bank1", ":foo.0:x"),
                ...
                createInstruction(LABEL, label(6)),
                createInstruction(PRINT, ":foo.0:y"),
                createInstruction(SET, ":foo.0:x", "1"),
                createInstruction(CALLREC, "bank1", label(0), label(8), ":foo.0*retval"),
    ...
    void removesUnmodifiedVariables() {
        ...
        assertCompilesTo("""
                ...
                createInstruction(JUMP, label(1), "equal", "bank1", "null"),
                createInstruction(SET, "*sp", "0"),
                createInstruction(SET, ":foo.0:m", "message1"),
                createInstruction(SET, ":foo.0:n", "10"),
                createInstruction(CALLREC, "bank1", label(0), label(2), ":foo.0*retval"),
                createInstruction(LABEL, label(2)),
                createInstruction(END),
                createInstruction(LABEL, label(0)),
                createInstruction(SET, tmp(1), ":foo.0:n"),
                createInstruction(SET, ":foo.0:i", "1"),
                createInstruction(LABEL, label(4)),
                createInstruction(JUMP, label(6), "greaterThan", ":foo.0:i", tmp(1)),
                createInstruction(PRINT, ":foo.0:n"),
                createInstruction(PRINTFLUSH, ":foo.0:m"),
                createInstruction(OP, "sub", tmp(2), ":foo.0:n", "1"),
                createInstruction(PUSH, "bank1", ":foo.0:n"),
                createInstruction(PUSH, "bank1", ":foo.0:i"),
                createInstruction(PUSH, "bank1", tmp(1)),
                createInstruction(SET, ":foo.0:n", tmp(2)),
                createInstruction(CALLREC, "bank1", label(0), label(7), ":foo.0*retval"),
                createInstruction(LABEL, label(7)),
                createInstruction(POP, "bank1", tmp(1)),
                createInstruction(POP, "bank1", ":foo.0:i"),
    ...
    void correctlyOptimizesQuicksort() {
        assertCompilesTo(
                ...
                createInstruction(CALLREC, "bank1", label(0), label(2), ":quicksort.0*retval"),
                createInstruction(LABEL, label(2)),
                createInstruction(END),
                createInstruction(LABEL, label(0)),
                ...
                createInstruction(CALLREC, "bank1", label(0), label(7), ":quicksort.0*retval"),
                createInstruction(LABEL, label(7)),
                ...
                createInstruction(CALLREC, "bank1", label(0), label(8), ":quicksort.0*retval"),
                createInstruction(LABEL, label(8)),
                createInstruction(SET, tmp(13), ":quicksort.0*retval"),
                ...
                createInstruction(SET, ":quicksort.0*retval", tmp(3)),
                createInstruction(RETURNREC, "bank1")
        );
    }
}
