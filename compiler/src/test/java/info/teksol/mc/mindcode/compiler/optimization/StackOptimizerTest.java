...
class StackOptimizerTest extends AbstractOptimizerTest<StackOptimizer> {
    ...
    void removesUnusedParameter() {
        assertCompilesTo("""
                        ...
                        print(foo(5));
                        """,
                createInstruction(INITSTACK, label(101), label(102)),
    ...
    void removesVariablesNotInLoop() {
        assertCompilesTo("""
                ...
                createInstruction(CALLREC, "bank1", label(0), label(9), ":foo*retval"),
                ...
                createInstruction(CALLREC, "bank1", label(0), label(10), ":foo*retval"),
    ...
    void correctlyOptimizesQuicksort() {
        assertCompilesTo(
                ...
                createInstruction(CALLREC, "bank1", label(0), label(3), ":quicksort*retval"),
                createInstruction(LABEL, label(3)),
                createInstruction(END),
                createInstruction(LABEL, label(0)),
                createInstruction(ASSERT_BOUNDS, "decimal", "1", "0", "lessThanEq", "*sp", "lessThan", "512", q("position 3:1: stack overflow error")),
                ...
                createInstruction(CALLREC, "bank1", label(0), label(9), ":quicksort*retval"),
                createInstruction(LABEL, label(9)),
