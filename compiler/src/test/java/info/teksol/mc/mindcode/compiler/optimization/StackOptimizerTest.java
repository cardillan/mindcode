...
class StackOptimizerTest extends AbstractOptimizerTest<StackOptimizer> {
    ...
    void removesUnusedParameter() {
        assertCompilesTo("""
                ...
                createInstruction(ASSERT_BOUNDS, "decimal", "1", "0", "lessThanEq", "*sp", "lessThanEq", "512", q("position 3:1: stack overflow error")),
    ...
    void removesVariablesNotInLoop() {
        assertCompilesTo("""
                ...
                createInstruction(INITREC, "false"),
                createInstruction(LABEL, label(6)),
                createInstruction(JUMP, label(8), "equal", "true", "false"),
                createInstruction(OP, "sub", tmp(1), ":foo:x", "1"),
                createInstruction(SET, ":foo:y", tmp(1)),
                createInstruction(PUSH, ":foo:x"),
                createInstruction(PUSH, ":foo:y"),
                createInstruction(SET, ":foo:x", "2"),
                createInstruction(CALLREC, label(0), label(9), ":foo*retval"),
                ...
                createInstruction(CALLREC, label(0), label(10), ":foo*retval"),
    ...
    void removesUnmodifiedVariables() {
        ...
        assertCompilesTo("""
                ...
                createInstruction(LABEL, label(6)),
                createInstruction(JUMP, label(8), "greaterThan", ":foo:i", tmp(1)),
                ...
                createInstruction(PUSH, ":foo:i"),
                createInstruction(PUSH, tmp(1)),
                createInstruction(SET, ":foo:n", tmp(2)),
                createInstruction(CALLREC, label(0), label(9), ":foo*retval"),
                createInstruction(LABEL, label(9)),
                createInstruction(POP, tmp(1)),
                createInstruction(POP, ":foo:i"),
    ...
    void correctlyOptimizesQuicksort() {
        assertCompilesTo(
                ...
                createInstruction(CALLREC, label(0), label(3), ":quicksort*retval"),
                createInstruction(LABEL, label(3)),
                createInstruction(END),
                createInstruction(LABEL, label(0)),
                createInstruction(ASSERT_BOUNDS, "decimal", "1", "0", "lessThanEq", "*sp", "lessThanEq", "512", q("position 3:1: stack overflow error")),
                ...
                createInstruction(JUMP, label(5), "equal", tmp(2), "false"),
                ...
                createInstruction(PUSH, ":quicksort:right"),
                createInstruction(PUSH, ":quicksort:new_pivot_index"),
                createInstruction(SET, ":quicksort:right", tmp(10)),
                createInstruction(CALLREC, label(0), label(8), ":quicksort*retval"),
                createInstruction(LABEL, label(8)),
                createInstruction(POP, ":quicksort:new_pivot_index"),
                createInstruction(POP, ":quicksort:right"),
                createInstruction(OP, "add", tmp(12), ":quicksort:new_pivot_index", "1"),
                createInstruction(SET, ":quicksort:left", tmp(12)),
                createInstruction(CALLREC, label(0), label(9), ":quicksort*retval"),
                createInstruction(LABEL, label(9)),
