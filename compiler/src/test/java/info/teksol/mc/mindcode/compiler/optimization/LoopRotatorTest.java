    ...
    class ShortCircuitBooleanEvaluations {
        ...
        void supportsDataFlowOptimization() {
            assertCompilesTo("""
                    ...
                    createInstruction(JUMP, label(8), "notEqual", ":a", "false"),
                    createInstruction(JUMP, label(8), "notEqual", ":b", "false"),
                    createInstruction(JUMP, label(8), "notEqual", ":c", "false"),
        ...
        void handlesSideEffects() {
            assertCompilesTo("""
                    ...
                    createInstruction(JUMP, label(18), "notEqual", ":a", "false"),
        ...
        void eliminatesUnnecessaryJumps() {
            assertCompilesTo("""
                    ...
                    createInstruction(PRINT, q("In loop")),
                    createInstruction(SENSOR, tmp(0), "switch1", "@enabled"),
                    createInstruction(JUMP, label(7), "notEqual", tmp(0), "false"),
