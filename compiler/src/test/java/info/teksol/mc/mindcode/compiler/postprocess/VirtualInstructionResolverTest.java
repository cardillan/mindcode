    ...
    class InternalArrays {
        ...
        void expandsArrayAccessWithBoundCheckAssert() {
            assertCompilesTo(
                    ...
                    createInstruction(OP, "sub", tmp(0), ":i", "1"),
                    createInstruction(ASSERT_BOUNDS, "multiple", "1", "0", "lessThanEq", tmp(0), "lessThanEq", "2", q("position 11:5: index out of bounds (0 to 2)")),
                    createInstruction(OP, "shl", tmp(1), tmp(0), "1"),
                    createInstruction(OP, "add", "@counter", "21", tmp(1)),
                    createInstruction(SET, ".a*w", ".a*r"),
                    createInstruction(ASSERT_BOUNDS, "multiple", "1", "0", "lessThanEq", ":i", "lessThanEq", "2", q("position 11:5: index out of bounds (0 to 2)")),
                    createInstruction(OP, "shl", tmp(2), ":i", "1"),
                    createInstruction(OP, "add", "@counter", "27", tmp(2)),
                    createInstruction(OP, "add", ":i", ":i", "1"),
                    createInstruction(JUMP, "7", "lessThan", ":i", "LIMIT"),
                    createInstruction(PRINT, ".a*0"),
                    createInstruction(PRINT, ".a*1"),
        ...
        void expandsArrayAccessWithBoundCheckMinimal() {
            assertCompilesTo(
                    ...
                    createInstruction(OP, "sub", tmp(0), ":i", "1"),
                    createInstruction(JUMP, "8", "greaterThan", "0", tmp(0)),
                    createInstruction(JUMP, "9", "greaterThan", tmp(0), "2"),
                    createInstruction(OP, "shl", tmp(1), tmp(0), "1"),
                    createInstruction(OP, "add", "@counter", "23", tmp(1)),
                    createInstruction(SET, ".a*w", ".a*r"),
                    createInstruction(JUMP, "13", "greaterThan", "0", ":i"),
                    createInstruction(JUMP, "14", "greaterThan", ":i", "2"),
                    createInstruction(OP, "shl", tmp(2), ":i", "1"),
                    createInstruction(OP, "add", "@counter", "29", tmp(2)),
                    createInstruction(OP, "add", ":i", ":i", "1"),
                    createInstruction(JUMP, "7", "lessThan", ":i", "LIMIT"),
                    createInstruction(PRINT, ".a*0"),
                    createInstruction(PRINT, ".a*1"),
        ...
        void expandsArrayAccessWithBoundCheckSimple() {
            assertCompilesTo(
                    ...
                    createInstruction(OP, "sub", tmp(0), ":i", "1"),
                    createInstruction(JUMP, "10", "greaterThan", "0", tmp(0)),
                    createInstruction(JUMP, "11", "lessThanEq", tmp(0), "2"),
                    createInstruction(STOP),
                    createInstruction(OP, "shl", tmp(1), tmp(0), "1"),
                    createInstruction(OP, "add", "@counter", "25", tmp(1)),
                    createInstruction(SET, ".a*w", ".a*r"),
                    createInstruction(JUMP, "16", "greaterThan", "0", ":i"),
                    createInstruction(JUMP, "17", "lessThanEq", ":i", "2"),
                    createInstruction(STOP),
                    createInstruction(OP, "shl", tmp(2), ":i", "1"),
                    createInstruction(OP, "add", "@counter", "31", tmp(2)),
                    createInstruction(OP, "add", ":i", ":i", "1"),
                    createInstruction(JUMP, "7", "lessThan", ":i", "LIMIT"),
                    createInstruction(PRINT, ".a*0"),
                    createInstruction(PRINT, ".a*1"),
        ...
        void expandsArrayAccessWithBoundCheckDescribed() {
            assertCompilesTo(
                    ...
                    createInstruction(OP, "sub", tmp(0), ":i", "1"),
                    createInstruction(JUMP, "10", "greaterThan", "0", tmp(0)),
                    createInstruction(JUMP, "12", "lessThanEq", tmp(0), "2"),
                    createInstruction(PRINT, q("position 11:5: index out of bounds (0 to 2)")),
                    createInstruction(STOP),
                    createInstruction(OP, "shl", tmp(1), tmp(0), "1"),
                    createInstruction(OP, "add", "@counter", "27", tmp(1)),
                    createInstruction(SET, ".a*w", ".a*r"),
                    createInstruction(JUMP, "17", "greaterThan", "0", ":i"),
                    createInstruction(JUMP, "19", "lessThanEq", ":i", "2"),
                    createInstruction(PRINT, q("position 11:5: index out of bounds (0 to 2)")),
                    createInstruction(STOP),
                    createInstruction(OP, "shl", tmp(2), ":i", "1"),
                    createInstruction(OP, "add", "@counter", "33", tmp(2)),
                    createInstruction(OP, "add", ":i", ":i", "1"),
                    createInstruction(JUMP, "7", "lessThan", ":i", "LIMIT"),
                    createInstruction(PRINT, ".a*0"),
                    createInstruction(PRINT, ".a*1"),
    ...
    class ExternalArrays {
        ...
        void expandsArrayAccessWithBoundCheckMinimal() {
            assertCompilesTo(
                    ...
                    createInstruction(SET, ":i", "0"),
                    createInstruction(OP, "sub", tmp(0), ":i", "1"),
                    createInstruction(JUMP, "6", "greaterThan", "0", tmp(0)),
                    createInstruction(JUMP, "7", "greaterThan", tmp(0), "2"),
                    createInstruction(READ, tmp(1), "cell1", tmp(0)),
                    createInstruction(JUMP, "9", "greaterThan", "0", ":i"),
                    createInstruction(JUMP, "10", "greaterThan", ":i", "2"),
                    createInstruction(WRITE, tmp(1), "cell1", ":i"),
                    createInstruction(OP, "add", ":i", ":i", "1"),
                    createInstruction(JUMP, "5", "lessThan", ":i", "LIMIT"),
                    ...
                    createInstruction(READ, tmp(4), "cell1", "2"),
        ...
        void expandsArrayAccessWithBoundCheckSimple() {
            assertCompilesTo(
                    ...
                    createInstruction(OP, "sub", tmp(0), ":i", "1"),
                    createInstruction(JUMP, "8", "greaterThan", "0", tmp(0)),
                    createInstruction(JUMP, "9", "lessThanEq", tmp(0), "2"),
                    createInstruction(STOP),
                    createInstruction(READ, tmp(1), "cell1", tmp(0)),
                    createInstruction(JUMP, "12", "greaterThan", "0", ":i"),
        ...
        void expandsArrayAccessWithBoundCheckDescribed() {
            assertCompilesTo(
                    ...
                    createInstruction(OP, "sub", tmp(0), ":i", "1"),
                    createInstruction(JUMP, "8", "greaterThan", "0", tmp(0)),
                    createInstruction(JUMP, "10", "lessThanEq", tmp(0), "2"),
                    createInstruction(PRINT, q("position 11:5: index out of bounds (0 to 2)")),
                    createInstruction(STOP),
                    createInstruction(READ, tmp(1), "cell1", tmp(0)),
                    createInstruction(JUMP, "13", "greaterThan", "0", ":i"),
