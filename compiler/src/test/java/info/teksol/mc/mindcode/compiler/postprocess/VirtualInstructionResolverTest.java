    ...
    class InternalArrays {
        ...
        void expandsArrayAccessWithBoundCheckMinimal() {
            assertCompilesTo(
                    ...
                    createInstruction(JUMP, "9", "greaterThan", "0", tmp(1)),
                    createInstruction(JUMP, "10", "greaterThan", tmp(1), "4"),
                    createInstruction(OP, "add", "@counter", "23", tmp(1)),
                    createInstruction(SET, ".a*w", ".a*r"),
                    createInstruction(OP, "shl", tmp(2), ":i", "1"),
                    createInstruction(JUMP, "14", "greaterThan", "0", tmp(2)),
                    createInstruction(JUMP, "15", "greaterThan", tmp(2), "4"),
        ...
        void expandsArrayAccessWithBoundCheckSimple() {
            assertCompilesTo(
                    ...
                    createInstruction(OP, "sub", tmp(0), ":i", "1"),
                    createInstruction(OP, "shl", tmp(1), tmp(0), "1"),
                    createInstruction(JUMP, "11", "greaterThan", "0", tmp(1)),
                    createInstruction(JUMP, "12", "lessThanEq", tmp(1), "4"),
                    createInstruction(STOP),
                    createInstruction(OP, "add", "@counter", "25", tmp(1)),
                    createInstruction(SET, ".a*w", ".a*r"),
                    createInstruction(OP, "shl", tmp(2), ":i", "1"),
                    createInstruction(JUMP, "17", "greaterThan", "0", tmp(2)),
                    createInstruction(JUMP, "18", "lessThanEq", tmp(2), "4"),
                    createInstruction(STOP),
        ...
        void expandsArrayAccessWithBoundCheckDescribed() {
            assertCompilesTo(
                    ...
                    createInstruction(OP, "shl", tmp(1), tmp(0), "1"),
                    createInstruction(JUMP, "11", "greaterThan", "0", tmp(1)),
                    createInstruction(JUMP, "13", "lessThanEq", tmp(1), "4"),
                    createInstruction(PRINT, q("position 11:5: index out of bounds (0 to 2)")),
                    createInstruction(STOP),
                    createInstruction(OP, "add", "@counter", "27", tmp(1)),
                    createInstruction(SET, ".a*w", ".a*r"),
                    createInstruction(OP, "shl", tmp(2), ":i", "1"),
                    createInstruction(JUMP, "18", "greaterThan", "0", tmp(2)),
                    createInstruction(JUMP, "20", "lessThanEq", tmp(2), "4"),
                    createInstruction(PRINT, q("position 11:5: index out of bounds (0 to 2)")),
                    createInstruction(STOP),
