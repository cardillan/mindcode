    ...
    class InternalArrays {
        ...
        void expandsArrayAccessWithBoundCheckAssert() {
            assertCompilesTo(
                    ...
                    createInstruction(OP, "sub", tmp(2), ":i", "1"),
                    createInstruction(OP, "mul", tmp(5), tmp(2), "2"),
                    createInstruction(ASSERT_BOUNDS, "multiple", "2", "0", "lessThanEq", tmp(5), "lessThanEq", "4", q("position 10:5: index out of bounds (0 to 2)")),
        ...
        void expandsArrayAccessWithBoundCheckMinimal() {
            assertCompilesTo(
                    ...
                    createInstruction(OP, "sub", tmp(2), ":i", "1"),
                    createInstruction(OP, "mul", tmp(5), tmp(2), "2"),
                    createInstruction(JUMP, "10", "lessThan", ":i", "1"),
                    createInstruction(JUMP, "11", "greaterThan", ":i", "3"),
                    createInstruction(OP, "add", "@counter", "24", tmp(5)),
                    createInstruction(SET, ".a*w", ".a*r"),
                    createInstruction(OP, "mul", tmp(6), ":i", "2"),
                    createInstruction(JUMP, "15", "lessThan", ":i", "0"),
                    createInstruction(JUMP, "16", "greaterThan", ":i", "2"),
        ...
        void expandsArrayAccessWithBoundCheckSimple() {
            assertCompilesTo(
                    ...
                    createInstruction(OP, "sub", tmp(2), ":i", "1"),
                    createInstruction(OP, "mul", tmp(5), tmp(2), "2"),
                    createInstruction(JUMP, "12", "lessThan", ":i", "1"),
        ...
        void expandsArrayAccessWithBoundCheckDescribed() {
            assertCompilesTo(
                    ...
                    createInstruction(OP, "mul", tmp(5), tmp(2), "2"),
                    createInstruction(JUMP, "12", "lessThan", ":i", "1"),
                    createInstruction(JUMP, "14", "lessThanEq", ":i", "3"),
                    createInstruction(PRINT, q("position 10:5: index out of bounds (0 to 2)")),
                    createInstruction(STOP),
                    createInstruction(OP, "add", "@counter", "28", tmp(5)),
                    createInstruction(SET, ".a*w", ".a*r"),
                    createInstruction(OP, "mul", tmp(6), ":i", "2"),
                    createInstruction(JUMP, "19", "lessThan", ":i", "0"),
                    createInstruction(JUMP, "21", "lessThanEq", ":i", "2"),
                    createInstruction(PRINT, q("position 10:5: index out of bounds (0 to 2)")),
                    createInstruction(STOP),
    ...
    class ExternalArrays {
        ...
        void expandsArrayAccessWithBoundCheckAssert() {
            assertCompilesTo(
                    ...
                    createInstruction(OP, "sub", tmp(6), ":i", "1"),
                    createInstruction(ASSERT_BOUNDS, "multiple", "1", "0", "lessThanEq", tmp(6), "lessThanEq", "2", q("position 10:5: index out of bounds (0 to 2)")),
                    createInstruction(READ, tmp(7), "cell1", tmp(6)),
                    createInstruction(ASSERT_BOUNDS, "multiple", "1", "0", "lessThanEq", ":i", "lessThanEq", "2", q("position 10:5: index out of bounds (0 to 2)")),
                    createInstruction(WRITE, tmp(7), "cell1", ":i"),
                    createInstruction(OP, "add", ":i", ":i", "1"),
                    createInstruction(JUMP, "6", "lessThan", ":i", "LIMIT"),
                    createInstruction(READ, tmp(0), "cell1", "0"),
        ...
        void expandsArrayAccessWithBoundCheckMinimal() {
            assertCompilesTo(
                    ...
                    createInstruction(OP, "sub", tmp(6), ":i", "1"),
                    createInstruction(JUMP, "7", "lessThan", ":i", "1"),
                    createInstruction(JUMP, "8", "greaterThan", ":i", "3"),
                    createInstruction(READ, tmp(7), "cell1", tmp(6)),
        ...
        void expandsArrayAccessWithBoundCheckDescribed() {
            assertCompilesTo(
                    ...
                    createInstruction(OP, "sub", tmp(6), ":i", "1"),
                    createInstruction(JUMP, "9", "lessThan", ":i", "1"),
                    createInstruction(JUMP, "11", "lessThanEq", ":i", "3"),
                    createInstruction(PRINT, q("position 10:5: index out of bounds (0 to 2)")),
                    createInstruction(STOP),
                    createInstruction(READ, tmp(7), "cell1", tmp(6)),
