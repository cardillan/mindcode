    ...
    class Target7 extends AbstractOptimizerTest<ArrayOptimizer> {
        ...
        void inlinesSmallArrays3() {
            assertCompilesTo("""
                    ...
                    createInstruction(JUMP, label(6), "greaterThanEq", "p", "2"),
                    createInstruction(SET, ".array*1", tmp(1)),
        ...
        void inlinesRegularArrays() {
            assertCompilesTo("""
                            ...
                            """,
                    createInstruction(SET, "p", "0"),
                    createInstruction(ASSERT_BOUNDS, "multiple", "1", "0", "lessThanEq", "p", "lessThanEq", "3", q("position 1:1: index out of bounds (0 to 3)")),
        ...
        void inlinesSingleJumpTable() {
            assertCompilesTo("""
                    ...
                    createInstruction(JUMP, label(5), "always"),
                    createInstruction(MULTILABEL, label(7)),
                    createInstruction(SET, tmp(1), ".array*1"),
                    createInstruction(JUMP, label(5), "always"),
                    createInstruction(MULTILABEL, label(8)),
                    createInstruction(SET, tmp(1), ".array*2"),
                    createInstruction(JUMP, label(5), "always"),
                    createInstruction(MULTILABEL, label(9)),
                    createInstruction(SET, tmp(1), ".array*3"),
                    createInstruction(JUMP, label(5), "always"),
                    createInstruction(MULTILABEL, label(10)),
                    createInstruction(SET, tmp(1), ".array*4"),
                    createInstruction(LABEL, label(5)),
                    createInstruction(PRINT, tmp(1)),
                    createInstruction(OP, "add", tmp(2), "p", "1"),
                    createInstruction(SETADDR, ".array*rret", label(11)),
                    createInstruction(ASSERT_BOUNDS, "multiple", "1", "0", "lessThanEq", tmp(2), "lessThanEq", "4", q("position 6:1: index out of bounds (0 to 4)")),
                    ...
                    createInstruction(ASSERT_BOUNDS, "multiple", "1", "0", "lessThanEq", tmp(6), "lessThanEq", "4", q("position 7:1: index out of bounds (0 to 4)")),
