...
class ArrayOptimizerTest extends AbstractOptimizerTest<ArrayOptimizer> {
    ...
    void inlinesSmallArrays2() {
        assertCompilesTo("""
                ...
                createInstruction(JUMP, label(0), "equal", "p", "0"),
    ...
    void inlinesSmallArrays3() {
        assertCompilesTo("""
                ...
                createInstruction(JUMP, label(2), "always"),
                createInstruction(LABEL, label(0)),
                createInstruction(JUMP, label(1), "notEqual", "p", "1"),
                createInstruction(SET, tmp(0), ".array*1"),
                createInstruction(JUMP, label(2), "always"),
                createInstruction(LABEL, label(1)),
                ...
                createInstruction(LABEL, label(2)),
                createInstruction(OP, "add", tmp(1), tmp(0), "1"),
                createInstruction(JUMP, label(3), "notEqual", "p", "0"),
                createInstruction(SET, ".array*0", tmp(1)),
                createInstruction(JUMP, label(5), "always"),
                createInstruction(LABEL, label(3)),
                createInstruction(JUMP, label(4), "notEqual", "p", "1"),
                createInstruction(SET, ".array*1", tmp(1)),
                createInstruction(JUMP, label(5), "always"),
    ...
    void inlinesRegularArrays() {
        assertCompilesTo("""
                ...
                createInstruction(LABEL, label(0)),
                createInstruction(OP, "add", tmp(1), tmp(0), "1"),
                createInstruction(OP, "mul", tmp(3), "p", "2"),
                createInstruction(MULTIJUMP, label(7), tmp(3), "0"),
