...
class CaseSwitcherTest extends AbstractOptimizerTest<CaseSwitcher> {
    ...
    void processesBasicSwitch() {
        assertCompilesTo("""
                ...
                createInstruction(MULTIJUMP, var(1023), "i", "0", var(1022)),
                createInstruction(MULTILABEL, var(1023), var(1022)),
                createInstruction(JUMP, var(1002), "always"),
                createInstruction(MULTILABEL, var(1024), var(1022)),
                createInstruction(JUMP, var(1004), "always"),
                createInstruction(MULTILABEL, var(1025), var(1022)),
                createInstruction(JUMP, var(1006), "always"),
                createInstruction(MULTILABEL, var(1026), var(1022)),
                createInstruction(JUMP, var(1008), "always"),
                createInstruction(MULTILABEL, var(1027), var(1022)),
                createInstruction(JUMP, var(1010), "always"),
                createInstruction(MULTILABEL, var(1028), var(1022)),
                createInstruction(JUMP, var(1012), "always"),
                createInstruction(MULTILABEL, var(1029), var(1022)),
                createInstruction(JUMP, var(1014), "always"),
                createInstruction(MULTILABEL, var(1030), var(1022)),
                createInstruction(JUMP, var(1016), "always"),
                createInstruction(MULTILABEL, var(1031), var(1022)),
                createInstruction(JUMP, var(1018), "always"),
                createInstruction(MULTILABEL, var(1032), var(1022)),
    ...
    void processesReturningSwitchWithElse() {
        assertCompilesTo("""
                ...
                createInstruction(MULTIJUMP, var(1013), "value", "0", var(1012)),
                createInstruction(MULTILABEL, var(1013), var(1012)),
                createInstruction(JUMP, var(1002), "always"),
                createInstruction(MULTILABEL, var(1014), var(1012)),
                createInstruction(JUMP, var(1004), "always"),
                createInstruction(MULTILABEL, var(1015), var(1012)),
                createInstruction(JUMP, var(1006), "always"),
                createInstruction(MULTILABEL, var(1016), var(1012)),
                createInstruction(JUMP, var(1006), "always"),
                createInstruction(MULTILABEL, var(1017), var(1012)),
                createInstruction(JUMP, var(1006), "always"),
                createInstruction(MULTILABEL, var(1018), var(1012)),
                createInstruction(JUMP, var(1008), "always"),
                createInstruction(MULTILABEL, var(1019), var(1012)),
                createInstruction(JUMP, var(1008), "always"),
                createInstruction(MULTILABEL, var(1020), var(1012)),
                createInstruction(JUMP, var(1008), "always"),
                createInstruction(MULTILABEL, var(1021), var(1012)),
                createInstruction(JUMP, var(1008), "always"),
                createInstruction(MULTILABEL, var(1022), var(1012)),
                createInstruction(JUMP, var(1011), "always"),
                createInstruction(MULTILABEL, var(1023), var(1012)),
                createInstruction(JUMP, var(1010), "always"),
                createInstruction(LABEL, var(1002)),
