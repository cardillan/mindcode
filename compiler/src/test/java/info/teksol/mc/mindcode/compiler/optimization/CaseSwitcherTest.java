...
class CaseSwitcherTest extends AbstractOptimizerTest<CaseSwitcher> {
    ...
    void processesBasicSwitch() {
        assertCompilesTo("""
                ...
                createInstruction(MULTIJUMP, var(1023), "i", "0"),
                createInstruction(MULTILABEL, var(1023)),
                createInstruction(JUMP, var(1002), "always"),
                createInstruction(MULTILABEL, var(1024)),
                createInstruction(JUMP, var(1004), "always"),
                createInstruction(MULTILABEL, var(1025)),
                createInstruction(JUMP, var(1006), "always"),
                createInstruction(MULTILABEL, var(1026)),
                createInstruction(JUMP, var(1008), "always"),
                createInstruction(MULTILABEL, var(1027)),
                createInstruction(JUMP, var(1010), "always"),
                createInstruction(MULTILABEL, var(1028)),
                createInstruction(JUMP, var(1012), "always"),
                createInstruction(MULTILABEL, var(1029)),
                createInstruction(JUMP, var(1014), "always"),
                createInstruction(MULTILABEL, var(1030)),
                createInstruction(JUMP, var(1016), "always"),
                createInstruction(MULTILABEL, var(1031)),
                createInstruction(JUMP, var(1018), "always"),
                createInstruction(MULTILABEL, var(1032)),
    ...
    void processesReturningSwitchWithElse() {
        assertCompilesTo("""
                ...
                createInstruction(MULTIJUMP, var(1013), "value", "0"),
                createInstruction(MULTILABEL, var(1013)),
                createInstruction(JUMP, var(1002), "always"),
                createInstruction(MULTILABEL, var(1014)),
                createInstruction(JUMP, var(1004), "always"),
                createInstruction(MULTILABEL, var(1015)),
                createInstruction(JUMP, var(1006), "always"),
                createInstruction(MULTILABEL, var(1016)),
                createInstruction(JUMP, var(1006), "always"),
                createInstruction(MULTILABEL, var(1017)),
                createInstruction(JUMP, var(1006), "always"),
                createInstruction(MULTILABEL, var(1018)),
                createInstruction(JUMP, var(1008), "always"),
                createInstruction(MULTILABEL, var(1019)),
                createInstruction(JUMP, var(1008), "always"),
                createInstruction(MULTILABEL, var(1020)),
                createInstruction(JUMP, var(1008), "always"),
                createInstruction(MULTILABEL, var(1021)),
                createInstruction(JUMP, var(1008), "always"),
                createInstruction(MULTILABEL, var(1022)),
