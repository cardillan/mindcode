...
@NullMarked
@Order(6)
public class EulerSymbolicLabelsTest extends AbstractProcessorTest {
    ...
    protected CompilerProfile createCompilerProfile() {
        return super.createCompilerProfile().setSymbolicLabels(true);
    }

    @AfterAll
    static void done() throws IOException {
        AbstractProcessorTest.done(SCRIPTS_DIRECTORY, EulerSymbolicLabelsTest.class.getSimpleName());
    }
