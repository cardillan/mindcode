    ...
    class FunctionCalls {
        ...
        void compilesRecursiveFibonacci() {
            assertCompilesTo("""
                    ...
                    createInstruction(CALLREC, "bank1", label(0), label(2), ":fib*retval"),
                    createInstruction(LABEL, label(2)),
                    createInstruction(PRINT, ":fib*retval"),
                    createInstruction(END),
                    createInstruction(LABEL, label(0)),
                    createInstruction(SET, ":fib*retval", ":fib:n"),
                    createInstruction(JUMP, label(5), "lessThan", ":fib:n", "2"),
        ...
        public void handlesInputOutputRecursiveFunctionParameters() {
            ...
            assertCompilesTo("""
                    ...
                    createInstruction(END),
                    createInstruction(LABEL, label(0)),
                    createInstruction(JUMP, label(4), "notEqual", ":foo:n", "0"),
