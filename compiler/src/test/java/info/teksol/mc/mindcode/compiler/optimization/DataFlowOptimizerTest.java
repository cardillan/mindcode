    ...
    class Arrays {
        ...
        void handlesArrays() {
            assertCompilesTo("""
                    ...
                    createInstruction(ASSERT_BOUNDS, "multiple", "2", "0", "lessThanEq", tmp(7), "lessThanEq", "2", q("position 10:5: index out of bounds (0 to 1)")),
                    ...
                    createInstruction(ASSERT_BOUNDS, "multiple", "2", "0", "lessThanEq", tmp(8), "lessThanEq", "2", q("position 14:5: index out of bounds (0 to 1)")),
