    ...
    class Arrays {
        ...
        void handlesArrays() {
            assertCompilesTo("""
                    ...
                    createInstruction(SETADDR, ".a*wret", var(1012)),
                    createInstruction(JUMP, var(1002), "greaterThanEq", "0", "LIMIT"),
                    createInstruction(LABEL, var(1006)),
                    createInstruction(OP, "add", var(2), ":i", "1"),
                    createInstruction(OP, "mul", var(3), "2", var(2)),
                    createInstruction(SET, ".a*w", var(3)),
                    createInstruction(OP, "mul", var(6), ":i", "2"),
                    createInstruction(MULTICALL, var(1008), var(6), "marker0"),
                    createInstruction(LABEL, var(1012)),
                    createInstruction(OP, "add", ":i", ":i", "1"),
                    createInstruction(JUMP, var(1006), "lessThan", ":i", "LIMIT"),
                    createInstruction(LABEL, var(1002)),
                    createInstruction(SET, ":i", "0"),
                    createInstruction(SETADDR, ".a*rret", var(1013)),
                    createInstruction(JUMP, "__start__", "greaterThanEq", "0", "LIMIT"),
                    createInstruction(LABEL, var(1007)),
                    createInstruction(OP, "mul", var(7), ":i", "2"),
                    createInstruction(MULTICALL, var(1010), var(7), "marker1"),
    ...
    class ExitPoints {
        ...
        void handlesReturnStatementsWithConditionalExpressions() {
            assertCompilesTo("""
                    ...
                    createInstruction(JUMP, var(1004), "greaterThanEq", ":fn0:n", "0"),
