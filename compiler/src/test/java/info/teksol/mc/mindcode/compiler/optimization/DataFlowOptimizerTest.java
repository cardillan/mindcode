...
class DataFlowOptimizerTest extends AbstractOptimizerTest<DataFlowOptimizer> {
    ...
    void generatesUninitializedWarning() {
        assertGeneratesMessages(expectedMessages()
                        .add("List of uninitialized variables: i."),
                """
                        j = i;
    ...
    void recognizesPartialIfStatementInitialization() {
        assertGeneratesMessages(expectedMessages()
                        .add("List of uninitialized variables: b."),
                """
                        if switch1.@enabled then
                            a = 1;
                            b = a;
    ...
    void generatesWarningsAboutLocalVariables() {
        assertGeneratesMessages(
                expectedMessages()
                        .add("List of uninitialized variables: foo.n."),
                """
                         def foo()
                             print(n);
                         end;
    ...
    */
    ...
    void leavesUninitializedVariables() {
        assertCompilesTo(
                expectedMessages()
                        .add("List of uninitialized variables: flag."),
                """
                        print(flag);
                        flag = 1;
                        """,
    ...
    void IdentifiesUninitializedVariables() {
        assertCompilesTo(expectedMessages()
                        .add("List of uninitialized variables: a, b."),
                """
                        if switch1.@enabled then
                            a = 1;
                        else
    ...
    void handlesCaseExpressionsWithWhenSideEffects() {
        assertCompilesTo(expectedMessages()
                        .add("List of uninitialized variables: x."),
                """
    ...
    void handlesAssignmentSequences() {
        assertCompilesTo(expectedMessages(
                        m -> m.add("3 instructions eliminated by Data Flow Optimization (4 iterations).")),
                """
                        i = 0;
                        print(i);
                        i += 1;
