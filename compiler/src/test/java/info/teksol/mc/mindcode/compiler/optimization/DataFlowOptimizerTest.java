    ...
    class Arrays {
        ...
        void handlesArrays() {
            assertCompilesTo("""
                    ...
                    createInstruction(ASSERT_BOUNDS, "multiple", "1", "0", "lessThanEq", ":i", "lessThanEq", "1", q("position 10:5: index out of bounds (0 to 1)")),
                    ...
                    createInstruction(ASSERT_BOUNDS, "multiple", "1", "0", "lessThanEq", ":i", "lessThanEq", "1", q("position 14:5: index out of bounds (0 to 1)")),
                    createInstruction(OP, "shl", tmp(8), ":i", "1"),
