...
class GeneralOptimizationTest extends AbstractOptimizerTest<Optimizer> {
    ...
    void correctlyOptimizesFunctionCallAndReturn() {
        assertCompilesTo("""
                ...
                createInstruction(CALLREC, "cell1", label(0), label(3), ":fn.0*retval"),
                createInstruction(LABEL, label(3)),
                createInstruction(SET, tmp(1), ":fn.0*retval"),
                createInstruction(SET, ":fn.0:n", "5"),
                createInstruction(CALLREC, "cell1", label(0), label(4), ":fn.0*retval"),
                createInstruction(LABEL, label(4)),
                createInstruction(OP, "add", tmp(3), tmp(1), ":fn.0*retval"),
                ...
                createInstruction(CALLREC, "cell1", label(0), label(6), ":fn.0*retval"),
                createInstruction(LABEL, label(6)),
                createInstruction(POP, "cell1", ":fn.0:n"),
                createInstruction(OP, "mul", ":fn.0*retval", "2", ":fn.0:n"),
