...
class GeneralOptimizationTest extends AbstractOptimizerTest<Optimizer> {
    ...
    void correctlyOptimizesFunctionCallAndReturn() {
        assertCompilesTo("""
                ...
                createInstruction(SET, ":fn:n", "4"),
                createInstruction(CALLREC, "cell1", label(0), label(1), ":fn*retval"),
                createInstruction(LABEL, label(1)),
                createInstruction(SET, tmp(1), ":fn*retval"),
                createInstruction(SET, ":fn:n", "5"),
                createInstruction(CALLREC, "cell1", label(0), label(2), ":fn*retval"),
                createInstruction(LABEL, label(2)),
                createInstruction(OP, "add", tmp(3), tmp(1), ":fn*retval"),
                createInstruction(WRITE, tmp(3), "cell2", "3"),
                createInstruction(READ, tmp(6), "cell2", "3"),
                createInstruction(OP, "add", tmp(5), tmp(6), "1"),
                ...
                createInstruction(PUSH, "cell1", ":fn:n"),
                ...
                createInstruction(POP, "cell1", ":fn:n"),
                createInstruction(OP, "mul", ":fn*retval", "2", ":fn:n"),
