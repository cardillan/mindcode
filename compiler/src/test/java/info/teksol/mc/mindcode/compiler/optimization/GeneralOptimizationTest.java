...
class GeneralOptimizationTest extends AbstractOptimizerTest<Optimizer> {
    ...
    void correctlyOptimizesFunctionCallAndReturn() {
        assertCompilesTo("""
                ...
                createInstruction(CALLREC, label(0), label(3), ":fn*retval"),
                createInstruction(LABEL, label(3)),
                createInstruction(SET, tmp(1), ":fn*retval"),
                createInstruction(SET, ":fn:n", "5"),
                createInstruction(CALLREC, label(0), label(4), ":fn*retval"),
                ...
                createInstruction(CALLREC, label(0), label(6), ":fn*retval"),
                createInstruction(LABEL, label(6)),
                createInstruction(POP, ":fn:n"),
