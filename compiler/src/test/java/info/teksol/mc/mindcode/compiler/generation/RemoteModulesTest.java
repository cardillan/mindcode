    ...
    class Basics {
        ...
        void compilesSynchronousCall() {
            assertCompilesTo("""
                    ...
                    createInstruction(READ, tmp(1), "processor1", q("*initialized")),
                    createInstruction(JUMP, label(2), "notEqual", tmp(1), "true"),
                    createInstruction(READ, ":foo*processor1*address", "processor1", q(":foo*processor1*address")),
                    createInstruction(WRITE, "10", "processor1", q(":foo:a")),
                    createInstruction(WRITE, "false", "processor1", q(":foo*finished")),
                    createInstruction(WRITE, ":foo*processor1*address", "processor1", q("@counter")),
        ...
        void compilesMultipleModules() {
            assertCompilesTo("""
                            ...
                            """,
                    createInstruction(LABEL, label(3)),
                    createInstruction(READ, tmp(11), "processor1", q("*initialized")),
                    createInstruction(JUMP, label(3), "notEqual", tmp(11), "true"),
                    createInstruction(READ, ":foo*processor1*address", "processor1", q(":foo*processor1*address")),
                    createInstruction(LABEL, label(4)),
                    createInstruction(READ, tmp(14), "processor2", q("*initialized")),
                    createInstruction(JUMP, label(4), "notEqual", tmp(14), "true"),
                    createInstruction(READ, ":baz*processor2*address", "processor2", q(":baz*processor2*address")),
                    ...
                    createInstruction(WRITE, ":baz*processor2*address", "processor2", q("@counter")),
        ...
        void compilesRemoteArrayAccess() {
            assertCompilesTo("""
                    ...
                    createInstruction(READ, tmp(10), "processor1", q("*initialized")),
                    createInstruction(JUMP, label(1), "notEqual", tmp(10), "true"),
