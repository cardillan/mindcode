...
public enum ExecutionFlag {
    ...
    ERR_NOT_AN_OBJECT               ("stop execution when a numerical value is used instead of an object"),
    ERR_NOT_A_NUMBER                ("stop execution when an object is used instead of a numerical value"),
