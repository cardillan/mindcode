...
// Such conditions will only be generated by explicit code, e.g. if false or if true.
// If a variable is involved (e.g.  ACTIVE = false; if ACTIVE ...) the jump won't be removed/replaced.
