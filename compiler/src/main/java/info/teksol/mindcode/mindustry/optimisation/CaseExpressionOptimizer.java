...
// the value of the case expression. The set instruction is removed, while the other instructions (one jump
// instruction per "when" branch) are updated to replace the __ast variable with the one used in the set statement.
//
