...
public interface MindcodeListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by the {@code list_directive}
	 * labeled alternative in {@link MindcodeParser#directive}.
	 * @param ctx the parse tree
	 */
	void enterList_directive(MindcodeParser.List_directiveContext ctx);
	/**
	 * Exit a parse tree produced by the {@code list_directive}
	 * labeled alternative in {@link MindcodeParser#directive}.
	 * @param ctx the parse tree
	 */
	void exitList_directive(MindcodeParser.List_directiveContext ctx);
	/**
	 * Enter a parse tree produced by the {@code strict_directive}
	 * labeled alternative in {@link MindcodeParser#directive}.
	 * @param ctx the parse tree
	 */
	void enterStrict_directive(MindcodeParser.Strict_directiveContext ctx);
	/**
	 * Exit a parse tree produced by the {@code strict_directive}
	 * labeled alternative in {@link MindcodeParser#directive}.
	 * @param ctx the parse tree
	 */
	void exitStrict_directive(MindcodeParser.Strict_directiveContext ctx);
	/**
	 * Enter a parse tree produced by the {@code relaxed_directive}
	 * labeled alternative in {@link MindcodeParser#directive}.
	 * @param ctx the parse tree
	 */
	void enterRelaxed_directive(MindcodeParser.Relaxed_directiveContext ctx);
	/**
	 * Exit a parse tree produced by the {@code relaxed_directive}
	 * labeled alternative in {@link MindcodeParser#directive}.
	 * @param ctx the parse tree
	 */
	void exitRelaxed_directive(MindcodeParser.Relaxed_directiveContext ctx);
	/**
	 * Enter a parse tree produced by {@link MindcodeParser#directive_list}.
	 * @param ctx the parse tree
	 */
	void enterDirective_list(MindcodeParser.Directive_listContext ctx);
	/**
	 * Exit a parse tree produced by {@link MindcodeParser#directive_list}.
	 * @param ctx the parse tree
	 */
	...
	/**
	 * Enter a parse tree produced by the {@code for_each_1}
	 * labeled alternative in {@link MindcodeParser#for_expression}.
	 * @param ctx the parse tree
	 */
	void enterFor_each_1(MindcodeParser.For_each_1Context ctx);
	/**
	 * Exit a parse tree produced by the {@code for_each_1}
	 * labeled alternative in {@link MindcodeParser#for_expression}.
	 * @param ctx the parse tree
	 */
	void exitFor_each_1(MindcodeParser.For_each_1Context ctx);
	/**
	 * Enter a parse tree produced by the {@code for_each_2}
	 * labeled alternative in {@link MindcodeParser#for_expression}.
	 * @param ctx the parse tree
	 */
	void enterFor_each_2(MindcodeParser.For_each_2Context ctx);
	/**
	 * Exit a parse tree produced by the {@code for_each_2}
	 * labeled alternative in {@link MindcodeParser#for_expression}.
	 * @param ctx the parse tree
	 */
