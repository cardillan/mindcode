...
public record CompilerOutput<T>(T output, List<MindcodeMessage> messages, ExecutionException executionException,
                                List<Assertion> assertions, TextBuffer textBuffer, int steps) {
