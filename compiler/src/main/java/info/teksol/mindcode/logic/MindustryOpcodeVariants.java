...
public class MindustryOpcodeVariants {
    ...
    private List<OpcodeVariant> initialize() {
        ...
        add(list, V7, V7, W, PROP, Opcode.SETPROP, sensor("property"), block("object"), in("value"));
        ...
        add(list, V6, V7, S, NONE, Opcode.CALL,    label("callAddr"));
        add(list, V6, V7, S, NONE, Opcode.CALLREC, block("memory"), label("callAddr"), label("retAddr"));
        add(list, V6, V7, S, NONE, Opcode.RETURN,  block("memory"));
        add(list, V6, V7, S, NONE, Opcode.GOTO,    in("address"));
        add(list, V6, V7, S, NONE, Opcode.SETADDR, out("result"),   in("address"));
