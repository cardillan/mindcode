...
/**
 * Facade for ANTLR4 lexer and parser. Parses an input file into
 */
public class MindcodeParserFacade {

    private static MindcodeParser.ProgramContext parse(Consumer<MindcodeMessage> messageConsumer, InputFiles.InputFile inputFile) {
