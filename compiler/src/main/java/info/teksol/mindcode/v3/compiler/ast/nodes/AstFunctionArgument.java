...
public class AstFunctionArgument extends AstBaseMindcodeNode {
    private final @Nullable AstMindcodeNode expression;
    private final boolean inModifier;
    private final boolean outModifier;

    public AstFunctionArgument(@NotNull InputPosition inputPosition, @NotNull AstMindcodeNode expression,
    ...
    public @Nullable AstMindcodeNode getExpression() {
        return expression;
    }
