...
public class AstBuilder extends MindcodeParserBaseVisitor<AstMindcodeNode> {
    ...
    public static AstMindcodeNode generate(InputFiles.InputFile inputFile, Consumer<MindcodeMessage> messageConsumer,
            ProgramContext program) {
        final AstBuilder builder = new AstBuilder(messageConsumer, inputFile);
        return builder.visit(program);
    }

    public AstBuilder(Consumer<MindcodeMessage> messageConsumer, InputFiles.InputFile inputFile) {
