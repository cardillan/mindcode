...
public interface MindcodeParserVisitor<T> extends ParseTreeVisitor<T> {
	 ...
	 * @return the visitor result
	 */
	T visitExpExpression(MindcodeParser.ExpExpressionContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by the {@code stmtDirectiveSet}
	 * labeled alternative in {@link MindcodeParser#directive}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitStmtDirectiveSet(MindcodeParser.StmtDirectiveSetContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by the {@code stmtHeapAllocation}
	 * labeled alternative in {@link MindcodeParser#allocation}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitStmtHeapAllocation(MindcodeParser.StmtHeapAllocationContext ctx);
	/**
	 * Visit a parse tree produced by the {@code stmtStackAllocation}
	 * labeled alternative in {@link MindcodeParser#allocation}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitStmtStackAllocation(MindcodeParser.StmtStackAllocationContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by the {@code whenValueExpression}
	 * labeled alternative in {@link MindcodeParser#whenValue}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitWhenValueExpression(MindcodeParser.WhenValueExpressionContext ctx);
	/**
	 * Visit a parse tree produced by the {@code whenValueRangeExpression}
	 * labeled alternative in {@link MindcodeParser#whenValue}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitWhenValueRangeExpression(MindcodeParser.WhenValueRangeExpressionContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link MindcodeParser#iterator}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitIterator(MindcodeParser.IteratorContext ctx);
}