...
public class AstFunctionParameter extends AstBaseMindcodeNode {
    private final @NotNull AstIdentifier name;
    private final boolean inModifier;
    private final boolean outModifier;
    private final boolean varargs;

    public AstFunctionParameter(InputPosition inputPosition, @NotNull AstIdentifier name, boolean inModifier,
