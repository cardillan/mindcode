...
public class ERR {
    ...
    public static final String ARRAY_UNSUPPORTED_MODIFIER = "Arrays cannot be declared '%s'.";
    ...
    public static final String FUNCTION_EXPORT_CONFLICT = "Export function '%s' conflicts with export function '%s': names of export functions must be unique.";
    public static final String FUNCTION_EXPORT_RECURSIVE = "Recursive function '%s' declared 'export'.";
    ...
    public static final String INVALID_MLOG_SYMBOL = "'%s' is not a valid name for an mlog variable.";
    ...
    public static final String MODIFIER_MLOG_LOOKUP_TOO_SMALL = "Lookup type '%s' can support only up to %d elements (required %d).";
    public static final String MODIFIER_MLOG_SIZE_MISMATCH = "Number of 'mlog' modifier values (%d) is different from the array size (%d).";
    public static final String MODIFIER_MLOG_TOO_MAY_VALUES = "Too many 'mlog' modifier values.";
    public static final String MODIFIER_MLOG_UNKNOWN_LOOKUP_TYPE = "Unrecognized lookup type '%s'.";
    public static final String MODIFIER_REQUIRES_GLOBAL_SCOPE = "The '%s' modifier cannot be used to declare local variables.";
