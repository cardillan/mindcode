...
public class Processor extends AbstractMessageEmitter {
    ...
    private boolean execute(LogicInstruction instruction) {
        ...
        return switch(instruction.getOpcode()) {
            ...
            case UNPACKCOLOR    -> executeUnpackColor((UnpackColorInstruction) instruction);
    ...
    private boolean executeUnpackColor(UnpackColorInstruction ix) {
        MindustryVariable r = getOrCreateVariable(ix.getR());
        MindustryVariable g = getOrCreateVariable(ix.getG());
        MindustryVariable b = getOrCreateVariable(ix.getB());
        MindustryVariable a = getOrCreateVariable(ix.getA());
        MindustryVariable color = getExistingVariable(ix.getColor());
