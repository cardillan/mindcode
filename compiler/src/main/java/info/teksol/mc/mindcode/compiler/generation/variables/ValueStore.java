...
///
/// The code generator uses instances of this class to represent and pass around the individual nodes
...
public interface ValueStore extends SourceElement {
    ...
    /// Generates code for initializing a newly created variable of this type. Most implementations do nothing.
    ///
    ...
    /// final location.
    ///
    /// Code builders using two-phase writing must ensure the written variable will not get overwritten
    /// by other code in between.
    ///
    /// The default implementation is adequate for simple values (mlog variables).
    ///
    /// @param creator assembler instance used to produce code for setting the value, if needed
    /// @return variable to use for writing
    ...
    ///
    /// Code builders using the two-phase writing must ensure the written variable will not get overwritten
    /// by other code in between.
    ///
    /// The default implementation is adequate for simple values (mlog variables).
    ///
