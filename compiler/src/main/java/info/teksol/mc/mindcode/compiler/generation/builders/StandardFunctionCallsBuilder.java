...
public class StandardFunctionCallsBuilder extends AbstractFunctionBuilder {
    ...
    private LogicValue processMatchedFunctionCall(MindcodeFunction function, AstFunctionCall call, List<FunctionArgument> arguments) {
    ...
    private LogicValue handleInlineFunctionCall(MindcodeFunction inlineFunction, List<FunctionArgument> arguments) {
        MindcodeFunction function = inlineFunction.inlineForCall(processor.nextFunctionPrefix());
