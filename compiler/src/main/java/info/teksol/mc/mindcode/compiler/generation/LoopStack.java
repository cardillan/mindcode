...
public class LoopStack extends AbstractMessageEmitter {
    ...
    public void enterLoop(InputPosition position, String loopLabel, LogicLabel breakLabel, LogicLabel continueLabel) {
    ...
    public LogicLabel getBreakLabel(InputPosition position, String loopLabel) {
        return getLabel(position, loopLabel, LoopLabels::breakLabel, "break");
    }

    public LogicLabel getContinueLabel(InputPosition position, String loopLabel) {
        return getLabel(position, loopLabel, LoopLabels::continueLabel, "continue");
    }

    private LogicLabel getLabel(InputPosition position, String loopLabel,
