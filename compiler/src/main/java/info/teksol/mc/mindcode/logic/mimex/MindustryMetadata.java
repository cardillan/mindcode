...
public class MindustryMetadata {
    ...
    private class LVarReader extends AbstractNamedContentReader<LVariable> {
        ...
        protected List<LVariable> createUnregistered() {
            return List.of(
                    new LVariable("links", "@links", false, false, false, 0.0),
                    new LVariable("mapw", "@mapw", false, false, false, 0.0),
                    new LVariable("maph", "@maph", false, false, false, 0.0),
                    new LVariable("wait", "@wait", false, false, false, 0.0),
                    new LVariable("thisx", "@thisx", false, false, false, 0.0),
                    new LVariable("thisy", "@thisy", false, false, false, 0.0)
            );
        }
        ...
        protected @Nullable LVariable create(String[] columns) {
            return columns[name].charAt(0) == '@' ? new LVariable(
