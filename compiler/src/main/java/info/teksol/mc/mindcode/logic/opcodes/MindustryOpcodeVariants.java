...
public class MindustryOpcodeVariants {
    ...
    public static NamedParameter loglevel(String name) {
        return new NamedParameter(InstructionParameterType.LOG_LEVEL, name);
    }
    ...
    public static NamedParameter querytype(String name) {
        return new NamedParameter(InstructionParameterType.QUERY_TYPE, name);
    }
