...
public interface ContextlessInstructionCreator {
    ...
    default AssertBoundsInstruction createAssertBounds(AstContext astContext, LogicKeyword type, LogicValue multiple, LogicValue lowerBound,
            Condition lowerCondition, LogicValue value, Condition upperCondition, LogicValue upperBound, LogicValue message) {
        return (AssertBoundsInstruction) createInstruction(astContext, ASSERT_BOUNDS, List.of(type, multiple,
                lowerBound, lowerCondition, value, upperCondition, upperBound, message));
    }
