...
public class IdentifiersBuilder extends AbstractCodeBuilder implements
    ...
    private ValueStore memoryArrayAccess(AstArrayAccess node, LogicValue memory) {
    ...
    private LogicValue resolveMemory(AstArrayAccess node, LogicValue memory) {
    ...
    private ValueStore storeArrayAccess(AstArrayAccess node, ArrayStore array) {
        ...
        return array.getElement(assembler, node.sourcePosition(), index, false);
    }
