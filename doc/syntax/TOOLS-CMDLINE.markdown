...
usage: mindcode cm [-h] [-c] [-w [{update,update-all,upgrade-all,force-update-all}]] [--watcher-version {v0,v1}]
                ...
                [-t {6,6.0,7.0,7.0w,7,7w,7.1,7.1w,8.0,8.0w,8.1,8.1w,8,8w,8.2,8.2w}] [-i {1..100000}]
                ...
                [--stack-depth {1..10000}] [--setrate {1..1000}] [--ipt {1..1000}]
...
Environment options:
  ...
  -t, --target {6,6.0,7.0,7.0w,7,7w,7.1,7.1w,8.0,8.0w,8.1,8.1w,8,8w,8.2,8.2w}
...
Mlog formatting options:
  ...
  --author author [author ...]
                         ...
                         signature
  --no-signature         prevents appending a signature  'Compiled  by  Mindcode 3.19.3 - github.com/cardillan/mindcode'
