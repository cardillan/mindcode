...
* Need to somehow link instructions to corresponding Ast nodes. When an Ast node is processed, an AST context will be 
...
* Allow properties to be called on any expression. The nature of the call will be determined by the porperty name.
