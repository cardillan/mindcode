...
* Changed the Schemacode compiler to correctly output positions of error messages generated by Mindcode compiler, taking into account the source file and/or position of the Mindcode program or program snippet within the Schemacode source file.  
