...
* **Breaking:** a backslash character (`\`) in a string literal is now always treated as an escape character, in all targets. When updating to this version, string literals containing backslashes need to be reviewed and updated.
