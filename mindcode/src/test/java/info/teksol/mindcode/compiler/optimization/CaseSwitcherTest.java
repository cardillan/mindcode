...
class CaseSwitcherTest extends AbstractOptimizerTest<CaseSwitcher> {
    ...
    void processesBasicSwitch() {
        assertCompilesTo("""
                ...
                createInstruction(OP, "min", var(2), "i", "10"),
                createInstruction(OP, "max", var(2), var(2), "-1"),
                createInstruction(GOTOOFFSET, var(1023), var(2), "-1", var(1022)),
                createInstruction(GOTOLABEL, var(1023), var(1022)),
                createInstruction(JUMP, var(1021), "always"),
                ...
                createInstruction(GOTOLABEL, var(1033), var(1022)),
                createInstruction(JUMP, var(1020), "always"),
                createInstruction(GOTOLABEL, var(1034), var(1022)),
                createInstruction(JUMP, var(1021), "always"),
    ...
    void processesReturningSwitchWithElse() {
        assertCompilesTo("""
                ...
                createInstruction(OP, "min", var(3), "value", "11"),
                createInstruction(OP, "max", var(3), var(3), "-1"),
                createInstruction(GOTOOFFSET, var(1013), var(3), "-1", var(1012)),
                ...
                createInstruction(JUMP, var(1011), "always"),
                createInstruction(GOTOLABEL, var(1024), var(1012)),
                createInstruction(JUMP, var(1010), "always"),
                createInstruction(GOTOLABEL, var(1025), var(1012)),
                createInstruction(JUMP, var(1011), "always"),
                createInstruction(LABEL, var(1002)),
