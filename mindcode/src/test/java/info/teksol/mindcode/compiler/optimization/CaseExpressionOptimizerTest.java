...
public class CaseExpressionOptimizerTest extends AbstractOptimizerTest<CaseExpressionOptimizer> {
    ...
    void optimizesCaseWithExpression() {
        assertCompilesTo("""
                        ...
                        print(x)
                        """,
                createInstruction(SENSOR, "__ast0", "vault1", "@firstItem"),
                createInstruction(JUMP, var(1001), "notEqual", "__ast0", "@lead"),
                createInstruction(SET, var(1), "1"),
                createInstruction(JUMP, var(1000), "always"),
                createInstruction(LABEL, var(1001)),
                createInstruction(JUMP, var(1003), "notEqual", "__ast0", "@coal"),
