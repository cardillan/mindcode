...
public class MindcodeParser extends Parser {
	...
	public static final int
		...
		IN=17, INLINE=18, LOOP=19, NULL=20, RETURN=21, SENSOR=22, STACK=23, THEN=24, 
		TRUE=25, WHEN=26, WHILE=27, ASSIGN=28, AT=29, COLON=30, COMMA=31, DIV=32, 
		IDIV=33, DOLLAR=34, DOT=35, EXP=36, MINUS=37, MOD=38, MUL=39, NOT=40, 
		BITWISE_NOT=41, PLUS=42, QUESTION_MARK=43, SEMICOLON=44, HASHSET=45, EXP_ASSIGN=46, 
		MUL_ASSIGN=47, DIV_ASSIGN=48, IDIV_ASSIGN=49, MOD_ASSIGN=50, PLUS_ASSIGN=51, 
		MINUS_ASSIGN=52, SHIFT_LEFT_ASSIGN=53, SHIFT_RIGHT_ASSIGN=54, BITWISE_AND_ASSIGN=55, 
		BITWISE_OR_ASSIGN=56, BITWISE_XOR_ASSIGN=57, AND_ASSIGN=58, OR_ASSIGN=59, 
		LESS_THAN=60, LESS_THAN_EQUAL=61, NOT_EQUAL=62, EQUAL=63, STRICT_EQUAL=64, 
		STRICT_NOT_EQUAL=65, GREATER_THAN_EQUAL=66, GREATER_THAN=67, AND=68, OR=69, 
		SHIFT_LEFT=70, SHIFT_RIGHT=71, BITWISE_AND=72, BITWISE_OR=73, BITWISE_XOR=74, 
		LEFT_SBRACKET=75, RIGHT_SBRACKET=76, LEFT_RBRACKET=77, RIGHT_RBRACKET=78, 
		LEFT_CBRACKET=79, RIGHT_CBRACKET=80, LITERAL=81, FLOAT=82, INT=83, HEXINT=84, 
		BININT=85, ID=86, SL_COMMENT=87, WS=88;
	public static final int
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'for'", "'heap'", "'if'", "'in'", "'inline'", "'loop'", "'null'", "'return'", 
			"'sensor'", "'stack'", "'then'", "'true'", "'when'", "'while'", "'='", 
			"'@'", "':'", "','", "'/'", "'\\'", "'$'", "'.'", "'**'", "'-'", "'%'", 
			"'*'", null, "'~'", "'+'", "'?'", "';'", "'#set'", "'**='", "'*='", "'/='", 
			"'\\='", "'%='", "'+='", "'-='", "'<<='", "'>>='", "'&='", "'|='", "'^='", 
			"'&&='", "'||='", "'<'", "'<='", "'!='", "'=='", "'==='", "'!=='", "'>='", 
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"IN", "INLINE", "LOOP", "NULL", "RETURN", "SENSOR", "STACK", "THEN", 
	...
	public final ProgramContext program() throws RecognitionException {
		...
		try {
			...
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 38638233940222L) != 0) || ((((_la - 77)) & ~0x3f) == 0 && ((1L << (_la - 77)) & 1009L) != 0)) {
				{
				setState(106);
				expression_list(0);
				}
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					case 2:
						...
						_la = _input.LA(1);
						if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & 837518622720L) != 0)) ) {
	...
	public final AssignContext assign() throws RecognitionException {
		...
		try {
			...
			case 2:
				...
				_la = _input.LA(1);
				if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & 1152851135862669312L) != 0)) ) {
