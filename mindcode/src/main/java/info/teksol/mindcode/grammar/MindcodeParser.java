...
public class MindcodeParser extends Parser {
	...
	public static final int
		...
		IN=17, INLINE=18, LOOP=19, NOINLINE=20, NULL=21, RETURN=22, SENSOR=23, 
		STACK=24, THEN=25, TRUE=26, WHEN=27, WHILE=28, ASSIGN=29, AT=30, COLON=31, 
		COMMA=32, DIV=33, IDIV=34, DOLLAR=35, DOT=36, EXP=37, MINUS=38, MOD=39, 
		MUL=40, NOT=41, BITWISE_NOT=42, PLUS=43, QUESTION_MARK=44, SEMICOLON=45, 
		HASHSET=46, EXP_ASSIGN=47, MUL_ASSIGN=48, DIV_ASSIGN=49, IDIV_ASSIGN=50, 
		MOD_ASSIGN=51, PLUS_ASSIGN=52, MINUS_ASSIGN=53, SHIFT_LEFT_ASSIGN=54, 
		SHIFT_RIGHT_ASSIGN=55, BITWISE_AND_ASSIGN=56, BITWISE_OR_ASSIGN=57, BITWISE_XOR_ASSIGN=58, 
		AND_ASSIGN=59, OR_ASSIGN=60, LESS_THAN=61, LESS_THAN_EQUAL=62, NOT_EQUAL=63, 
		EQUAL=64, STRICT_EQUAL=65, STRICT_NOT_EQUAL=66, GREATER_THAN_EQUAL=67, 
		GREATER_THAN=68, AND=69, OR=70, SHIFT_LEFT=71, SHIFT_RIGHT=72, BITWISE_AND=73, 
		BITWISE_OR=74, BITWISE_XOR=75, LEFT_SBRACKET=76, RIGHT_SBRACKET=77, LEFT_RBRACKET=78, 
		RIGHT_RBRACKET=79, LEFT_CBRACKET=80, RIGHT_CBRACKET=81, LITERAL=82, FLOAT=83, 
		INT=84, HEXINT=85, BININT=86, ID=87, SL_COMMENT=88, WS=89;
	public static final int
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'null'", "'return'", "'sensor'", "'stack'", "'then'", "'true'", "'when'", 
			"'while'", "'='", "'@'", "':'", "','", "'/'", "'\\'", "'$'", "'.'", "'**'", 
			"'-'", "'%'", "'*'", null, "'~'", "'+'", "'?'", "';'", "'#set'", "'**='", 
			"'*='", "'/='", "'\\='", "'%='", "'+='", "'-='", "'<<='", "'>>='", "'&='", 
			"'|='", "'^='", "'&&='", "'||='", "'<'", "'<='", "'!='", "'=='", "'==='", 
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"IN", "INLINE", "LOOP", "NOINLINE", "NULL", "RETURN", "SENSOR", "STACK", 
			"THEN", "TRUE", "WHEN", "WHILE", "ASSIGN", "AT", "COLON", "COMMA", "DIV", 
			"IDIV", "DOLLAR", "DOT", "EXP", "MINUS", "MOD", "MUL", "NOT", "BITWISE_NOT", 
			"PLUS", "QUESTION_MARK", "SEMICOLON", "HASHSET", "EXP_ASSIGN", "MUL_ASSIGN", 
	...
	public final ProgramContext program() throws RecognitionException {
		...
		try {
			...
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 77276468572414L) != 0) || ((((_la - 78)) & ~0x3f) == 0 && ((1L << (_la - 78)) & 1009L) != 0)) {
				{
				setState(106);
				expression_list(0);
				}
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					case 2:
						...
						_la = _input.LA(1);
						if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & 1675037245440L) != 0)) ) {
					...
					case 7:
						...
						_la = _input.LA(1);
						if ( !(((((_la - 61)) & ~0x3f) == 0 && ((1L << (_la - 61)) & 195L) != 0)) ) {
	...
	public final AssignContext assign() throws RecognitionException {
		...
		try {
			...
			case 2:
				...
				_la = _input.LA(1);
				if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & 2305702271725338624L) != 0)) ) {
